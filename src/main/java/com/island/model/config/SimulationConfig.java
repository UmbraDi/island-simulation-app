...
public class SimulationConfig {
    ...
    public static final int STATISTICS_PRINT_INTERVAL_DAYS = 1;

    public static final int ISLAND_PRINT_INTERVAL_DAYS = 30;

    public static final int SIMULATION_DURATION_MINUTES = 1;

    public static final double INITIAL_SATIETY_PERCENT = 0.7;

    public static final double DAILY_SATIETY_LOSS = 0.3;

    public static final double SATIETY_LOSS_PER_ACTION = 0.15;
}
